            ...
            {loadingBalance && totalUsd === 0 ? (
              ...
              <>
                <Text style={styles.balanceAmount}>
                  {balanceHidden ? '••••••' : `$${safeToFixed(totalUsd, 2)}`}
                </Text>
                <TouchableOpacity 
                ...
                >
                  <Text style={styles.hideBalanceIcon}>{balanceHidden ? '◎' : '◉'}</Text>
          ...
          <View style={styles.tokenList}>
            ...
            {hasSol && (
              ...
              >
                ...
                <View style={styles.tokenValues}>
                  <Text style={styles.tokenUsd}>{balanceHidden ? '••••' : `$${safeToFixed(solUsd + solUsdcBalance, 2)}`}</Text>
                  <Text style={styles.tokenBal}>{balanceHidden ? '••••' : `${safeToFixed(solBalance, 4)} SOL`}</Text>
                  {isTEE && (
                    <Text style={styles.tokenBalUsdc}>{balanceHidden ? '••••' : `${safeToFixed(solUsdcBalance, 2)} USDC`}</Text>
                  )}
                </View>
                <Text style={styles.rowChevron}>›</Text>
              </TouchableOpacity>
