...
//   const routeVault = route.params?.vault;
//   // Use route vault, or context vault, or TEE wallet from storage
...
//       // Load SOL balance
//       if (hasSol) {
//         const address = isTEE ? teeAddresses.solana : (vault.sol?.address || vault.address);
//         if (address) {
//           try {
//             const response = await api.getSolBalance(address);
//             const bal = response.sol || response.balance || 0;
...
//       // Load EVM balance for TEE wallets
//       if (hasEvm && teeAddresses.evm) {
//         try {
//           // TODO: Implement EVM balance API
//           // For now, set to 0
//           setEvmBalance(0);
//           setEvmUsd(0);
//         } catch (err) {
//           console.log('EVM balance error:', err);
//         }
//       }
//     } catch (error) {
//       console.log('Balance fetch error:', error);
...
//                 activeOpacity={0.7}
//                 onPress={() => copyAddress(teeAddresses.evm || undefined)}
//               >
//                 <View style={styles.tokenIcon}>
...
//                 </View>
//                 <View style={styles.tokenDetails}>
//                   <Text style={styles.tokenName}>Base (EVM)</Text>
//                   <View style={styles.tokenAddressWrap}>
//                     <Text style={styles.tokenAddress}>
...
//                 activeOpacity={0.7}
//                 onPress={() => copyAddress(isTEE ? teeAddresses.solana || undefined : (vault?.sol?.address || vault?.address))}
//               >
//                 <View style={styles.tokenIcon}>
//                   <LinearGradient
//                     colors={['#9945FF', '#14F195']}
...
//               setSolUsd(usd);
//             }
//             // Silently handle rate limit errors - don't update state
//           } catch (err: any) {
...
//       if (hasEvm && teeAddresses.evm) {
//         try {
//           // TODO: Implement EVM balance API when available
//           // For now, keep at 0
//         } catch (err) {
//           console.log('[Balance] EVM fetch failed');
//         }
//       }
//     } catch (error) {
