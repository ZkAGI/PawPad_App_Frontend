...
const FundWalletScreen = () => {
  ...
  const getCurrentAddress = () => {
    if (isTEE) {
      return selectedChain === 'solana' ? teeAddresses.solana : teeAddresses.evm;
    }
    // For non-TEE wallets
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerCenter}>
              ...
              <Text style={styles.subtitle}>Add funds to your wallet</Text>
            </View>
            <View style={styles.headerSpacer} />
          </View>

          {/* Chain Selector (TEE wallets only) */}
          {isTEE && (
            <View style={styles.chainSelector}>
              <TouchableOpacity
                style={[
                  styles.chainOption,
                  selectedChain === 'solana' && styles.chainOptionActive,
                ]}
                onPress={() => setSelectedChain('solana')}
                activeOpacity={0.7}
              >
                <View style={[styles.chainIcon, { backgroundColor: COLORS.solana }]}>
                  <Text style={styles.chainIconText}>◎</Text>
                </View>
                <View style={styles.chainInfo}>
                  <Text style={[
                    styles.chainName,
                    selectedChain === 'solana' && styles.chainNameActive,
                  ]}>Solana</Text>
                  <Text style={styles.chainSymbol}>SOL / USDC</Text>
                </View>
              ...
              <TouchableOpacity
                style={[
                  styles.chainOption,
                  selectedChain === 'evm' && styles.chainOptionActive,
                ]}
                onPress={() => setSelectedChain('evm')}
                activeOpacity={0.7}
              >
                <View style={[styles.chainIcon, { backgroundColor: COLORS.ethereum }]}>
                  <Text style={styles.chainIconText}>🔷</Text>
                </View>
                <View style={styles.chainInfo}>
                  <Text style={[
                    styles.chainName,
                    selectedChain === 'evm' && styles.chainNameActive,
                  ]}>Base (EVM)</Text>
                  <Text style={styles.chainSymbol}>ETH / USDC</Text>
                </View>
                {selectedChain === 'evm' && (
                  <View style={styles.checkMark}>
                    <Text style={styles.checkMarkText}>✓</Text>
          ...
          <View style={styles.qrCard}>
            <View style={styles.qrHeader}>
              <View style={[
                styles.qrChainBadge,
                { backgroundColor: selectedChain === 'solana' ? COLORS.solana : COLORS.ethereum }
              ]}>
                <Text style={styles.qrChainText}>
            ...
            <Text style={styles.scanText}>Scan to receive funds</Text>
          </View>
          ...
          <View style={styles.tokensCard}>
            <Text style={styles.tokensTitle}>Supported Tokens</Text>
            <View style={styles.tokensList}>
              {selectedChain === 'solana' ? (
                <>
                  <View style={styles.tokenItem}>
                    <View style={[styles.tokenIcon, { backgroundColor: COLORS.solana }]}>
                ...
                <>
                  <View style={styles.tokenItem}>
                    <View style={[styles.tokenIcon, { backgroundColor: COLORS.ethereum }]}>
                      <Text style={styles.tokenIconText}>Ξ</Text>
                    </View>
          ...
          <View style={styles.warningBox}>
            ...
            <Text style={styles.warningText}>
              Only send {selectedChain === 'solana' ? 'Solana' : 'Base'} network tokens to this address.
          ...
          <View style={styles.networkCard}>
            <View style={styles.networkRow}>
              ...
              <Text style={styles.networkValue}>
                {selectedChain === 'solana' ? 'Solana Mainnet' : 'Base Mainnet'}
              </Text>
            </View>
            <View style={styles.networkDivider} />
            <View style={styles.networkRow}>
              <Text style={styles.networkLabel}>Security</Text>
              <Text style={[styles.networkValue, { color: COLORS.accent }]}>
                🛡️ Oasis TEE Protected
              </Text>
            </View>
          </View>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>🛡️ Secured by Oasis TEE</Text>
          </View>
        </ScrollView>
      </SafeAreaView>
    </View>
