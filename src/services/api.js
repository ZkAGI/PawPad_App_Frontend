...
//         vault_id: vaultId, type, asset, amount, price,
//       });
//       return response.data;
//     } catch (error) {
//       return { success: false, error: error.message };
...
//     try {
//       const response = await axios.post(`${this.baseUrl}/lending/deposit`, { vault_id: vaultId, asset, amount });
//       return response.data;
//     } catch (error) {
//       return { success: false, error: error.message };
//     }
...
//     try {
//       const response = await axios.post(`${this.baseUrl}/lending/borrow`, { vault_id: vaultId, asset, amount });
//       return response.data;
//     } catch (error) {
//       return { success: false, error: error.message };
//     }
...
//     try {
//       const response = await axios.post(`${this.baseUrl}/lending/repay`, { vault_id: vaultId, asset, amount });
//       return response.data;
//     } catch (error) {
//       return { success: false, error: error.message };
//     }
...
//     try {
//       const response = await axios.post(`${this.baseUrl}/lending/withdraw`, { vault_id: vaultId, asset, amount });
//       return response.data;
//     } catch (error) {
//       return { success: false, error: error.message };
//     }
 ...
 * REPLACE your entire src/services/api.js with this file
 * 
 * Backend URL: https://pawpad-arcium-backend.onrender.com
 */
