...
We initially planned Expo SDK but it caused compatibility issues with native crypto modules
(`react-native-keychain`, `@solana/web3.js` polyfills).
Had to go bare React Native. May revisit when Expo crypto support improves.
